...
A higher level overview is available at [Intractions](Intractions.md) documentation.
...
```
**Intractive** enables the built-in drag/click behaviour. If you enable
Intractive for pan, then you'll have a basic plot that supports moving
...
**mode** a string specifies the pan mode for mouse Intraction. Accepted values:
...
(function($) {
    ...
    function initNevigation(plot, options) {
        ...
        function onDblClick(e) {
            ...
            if (!o.recenter.Intractive) { return; }
