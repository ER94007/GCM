...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    var Splitter = /** @class */ (function () {
        function Splitter() {
            ...
            this.splitEventDrag = memoize(this._splitIntraction);
            this.splitEventResize = memoize(this._splitIntraction);
        ...
        Splitter.prototype._splitIntraction = function (Intraction) {
            var splitStates = {};
            if (Intraction) {
                var affectedStores_1 = this._splitEventStore(Intraction.affectedEvents, this._getKeysForEventDefs(Intraction.affectedEvents));
                // can't rely on defKeys because event data is mutated
                var mutatedKeysByDefId = this._getKeysForEventDefs(Intraction.mutatedEvents);
                var mutatedStores_1 = this._splitEventStore(Intraction.mutatedEvents, mutatedKeysByDefId);
                var populate = function (key) {
                    if (!splitStates[key]) {
                        splitStates[key] = {
                            affectedEvents: affectedStores_1[key] || EMPTY_EVENT_STORE,
                            mutatedEvents: mutatedStores_1[key] || EMPTY_EVENT_STORE,
                            isEvent: Intraction.isEvent,
                        };
                    }
                };
    ...
    */
    ...
    function buildViewContext(viewSpec, viewApi, viewOptions, dateProfileGenerator, dateEnv, theme, pluginHooks, dispatch, getCurrentData, emitter, calendarApi, registerIntractiveComponent, unregisterIntractiveComponent) {
        return {
            dateEnv: dateEnv,
            options: viewOptions,
            ...
            registerIntractiveComponent: registerIntractiveComponent,
            unregisterIntractiveComponent: unregisterIntractiveComponent,
        };
    }
    ...
    // ------------------------------------------------------------------------------------------------------------------------
    function isIntractionValid(Intraction, context) {
        return isNewPropsValid({ eventDrag: Intraction }, context); // HACK: the eventDrag props is used for ALL Intractions
    }
    ...
    function isPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        if (state.eventDrag && !isIntractionPropsValid(state, context, dateSpanMeta, filterConfig)) {
            return false;
        }
    ...
    // ------------------------------------------------------------------------------------------------------------------------
    function isIntractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        var currentState = context.getCurrentData();
        var Intraction = state.eventDrag; // HACK: the eventDrag props is used for ALL Intractions
        var subjectEventStore = Intraction.mutatedEvents;
        var subjectDefs = subjectEventStore.defs;
        var subjectInstances = subjectEventStore.instances;
        var subjectConfigs = compileEventUis(subjectDefs, Intraction.isEvent ?
            state.eventUiBases :
        ...
        var otherEventStore = excludeInstances(state.eventStore, Intraction.affectedEvents.instances);
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            for (var otherInstanceId in otherInstances) {
                ...
                if (rangesIntersect(subjectRange, otherInstance.range)) {
                    ...
                    if (otherOverlap === false && Intraction.isEvent) {
                        return false;
                    }
    ...
    */
    var DateComponent = /** @class */ (function (_super) {
        ...
        // Validation
        // -----------------------------------------------------------------------------------------------------------------
        DateComponent.prototype.isIntractionValid = function (Intraction) {
            var dateProfile = this.props.dateProfile; // HACK
            var instances = Intraction.mutatedEvents.instances;
            ...
            return isIntractionValid(Intraction, this.context);
        };
    ...
    function createPlugin(input) {
        return {
            ...
            componentIntractions: input.componentIntractions || [],
            calendarIntractions: input.calendarIntractions || [],
    ...
    function combineHooks(hooks0, hooks1) {
        return {
            ...
            calendarIntractions: hooks0.calendarIntractions.concat(hooks1.calendarIntractions),
            componentIntractions: hooks0.componentIntractions.concat(hooks1.componentIntractions),
    ...
    */
    ...
    var Intraction = /** @class */ (function () {
        function Intraction(settings) {
            this.component = settings.component;
        }
        Intraction.prototype.destroy = function () {
        };
        return Intraction;
    }());
    function parseIntractionSettings(component, input) {
        return {
            component: component,
            el: input.el,
    ...
    function IntractionSettingsToStore(settings) {
        var _a;
        return _a = {},
    ...
    // global state
    var IntractionSettingsStore = {};

    /*
    An abstraction for a dragging Intraction originating on an event.
    ...
    */
    ...
    var CalendarContent = /** @class */ (function (_super) {
        ...
        function CalendarContent() {
            ...
            _this.IntractionsStore = {};
            // Component Registration
            // -----------------------------------------------------------------------------------------------------------------
            _this.registerIntractiveComponent = function (component, settingsInput) {
                var settings = parseIntractionSettings(component, settingsInput);
                var DEFAULT_IntraCTIONS = [
                    EventClicking,
                    EventHovering,
                ];
                var IntractionClasses = DEFAULT_IntraCTIONS.concat(_this.props.pluginHooks.componentIntractions);
                var Intractions = IntractionClasses.map(function (TheIntractionClass) { return new TheIntractionClass(settings); });
                _this.IntractionsStore[component.uid] = Intractions;
                IntractionSettingsStore[component.uid] = settings;
            };
            _this.unregisterIntractiveComponent = function (component) {
                for (var _i = 0, _a = _this.IntractionsStore[component.uid]; _i < _a.length; _i++) {
                    var listener = _a[_i];
                    listener.destroy();
                }
                delete _this.IntractionsStore[component.uid];
                delete IntractionSettingsStore[component.uid];
            };
            // Resizing
            // -----------------------------------------------------------------------------------------------------------------
        ...
        */
        CalendarContent.prototype.render = function () {
            ...
            var viewContext = this.buildViewContext(props.viewSpec, props.viewApi, props.options, props.dateProfileGenerator, props.dateEnv, props.theme, props.pluginHooks, props.dispatch, props.getCurrentData, props.emitter, props.calendarApi, this.registerIntractiveComponent, this.unregisterIntractiveComponent);
        ...
        CalendarContent.prototype.componentDidMount = function () {
            var props = this.props;
            this.calendarIntractions = props.pluginHooks.calendarIntractions
                .map(function (CalendarIntractionClass) { return new CalendarIntractionClass(props); });
        ...
        CalendarContent.prototype.componentWillUnmount = function () {
            ...
            for (var _i = 0, _a = this.calendarIntractions; _i < _a.length; _i++) {
                var Intraction = _a[_i];
                Intraction.destroy();
            }
    ...
    var Slicer = /** @class */ (function () {
        function Slicer() {
            ...
            this.sliceEventDrag = memoize(this._sliceIntraction);
            this.sliceEventResize = memoize(this._sliceIntraction);
        ...
        Slicer.prototype._sliceIntraction = function (Intraction, eventUiBases, dateProfile, nextDayThreshold) {
            var extraArgs = [];
            for (var _i = 4; _i < arguments.length; _i++) {
                extraArgs[_i - 4] = arguments[_i];
            }
            ...
            var rangeRes = sliceEventStore(Intraction.mutatedEvents, eventUiBases, computeActiveRange(dateProfile, Boolean(nextDayThreshold)), nextDayThreshold);
            return {
                segs: this.sliceEventRanges(rangeRes.fg, extraArgs),
                affectedInstances: Intraction.affectedEvents.instances,
                isEvent: Intraction.isEvent,
            };
        };
    ...
    var ElementMirror = /** @class */ (function () {
        ...
        ElementMirror.prototype.getMirrorEl = function () {
            ...
            if (!mirrorEl) {
                ...
                // we don't want long taps or any mouse Intraction causing selection/menus.
    ...
    */
    ...
    /*
    For a pointer Intraction, automatically scrolls certain scroll containers when the pointer
    approaches the edge.
    ...
    */
    var FeaturefulElementDragging = /** @class */ (function (_super) {
        ...
        function FeaturefulElementDragging(containerEl, selector) {
            ...
            _this.isIntracting = false; // is the user validly moving the pointer? lasts until pointerup
            ...
            _this.onPointerDown = function (ev) {
                if (!_this.isDragging) { // so new drag doesn't happen while revert animation is going
                    ...
                    if (_this.isIntracting && // not destroyed via pointerdown handler
        ...
        FeaturefulElementDragging.prototype.destroy = function () {
            ...
            // TODO: fire 'dragend' directly and stop Intraction. discourage use of pointerup event (b/c might not fire)
            this.onPointerUp({});
        };
    ...
    */
    ...
    // certain clipping containers should never constrain Intractions, like <html> and <body>
    ...
    */
    var HitDragging = /** @class */ (function () {
        ...
        HitDragging.prototype.prepareHits = function () {
            this.offsetTrackers = mapHash(this.droppableStore, function (IntractionSettings) {
                IntractionSettings.component.prepareHits();
                return new OffsetTracker(IntractionSettings.el);
            });
        };
    ...
    */
    var DateClicking = /** @class */ (function (_super) {
        ...
        function DateClicking(settings) {
            ...
            var hitDragging = _this.hitDragging = new HitDragging(_this.dragging, IntractionSettingsToStore(settings));
        ...
        function EventDragging(settings) {
            ...
            _this.handleDragStart = function (ev) {
                ...
                if (ev.isTouch) {
                    ...
                    // if now using mouse, but was previous touch Intraction, clear selected event
            ...
            _this.handleHitUpdate = function (hit, isFinal) {
                ...
                if (hit) {
                    ...
                    if (initialContext === receivingContext ||
                        ...
                        if (mutation) {
                            ...
                            Intraction.mutatedEvents = mutatedRelevantEvents;
                            if (!receivingComponent.isIntractionValid(Intraction)) {
                                isInvalid = true;
                                mutation = null;
                                mutatedRelevantEvents = null;
                                Intraction.mutatedEvents = createEmptyEventStore();
                            }
                        }
                    }
                    else {
                ...
                _this.displayDrag(receivingContext, Intraction);
                if (!isInvalid) {
                    enableCursor();
                }
                else {
            ...
            dragging.touchScrollAllowed = false;
            dragging.autoScroller.isEnabled = options.dragScroll;
            var hitDragging = _this.hitDragging = new HitDragging(_this.dragging, IntractionSettingsStore);
        ...
        function EventResizing(settings) {
            ...
            _this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (mutation) {
                    ...
                    Intraction.mutatedEvents = mutatedRelevantEvents;
                    if (!_this.component.isIntractionValid(Intraction)) {
                        isInvalid = true;
                        mutation = null;
                        mutatedRelevantEvents = null;
                        Intraction.mutatedEvents = null;
                    }
                }
    ...
    var UnselectAuto = /** @class */ (function () {
        function UnselectAuto(context) {
            ...
            this.onDocumentPointerDown = function (pev) {
                ...
                _this.matchesEvent = !!elementClosest(downEl, EventDragging.SELECTOR); // Intraction started on an event?
            };
            this.onDocumentPointerUp = function (pev) {
                ...
                if (!documentPointer.wasTouchScroll) {
                    ...
                    if (calendarState.eventSelection && // an existing event selected?
                        !_this.matchesEvent // Intraction DIDN'T start on an event
                    ) {
    ...
    */
    var ExternalElementDragging = /** @class */ (function () {
        function ExternalElementDragging(dragging, suppliedDragMeta) {
            ...
            this.handleHitUpdate = function (hit, isFinal, ev) {
                ...
                if (hit) {
                    ...
                    if (_this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
                        ...
                        Intraction.mutatedEvents = eventTupleToStore(droppableEvent);
                        isInvalid = !isIntractionValid(Intraction, receivingContext);
                        if (isInvalid) {
                            Intraction.mutatedEvents = createEmptyEventStore();
                            droppableEvent = null;
                        }
            ...
            var hitDragging = this.hitDragging = new HitDragging(dragging, IntractionSettingsStore);
    ...
    */
    ...
    /*
    Detects when a *THIRD-PARTY* drag-n-drop system Intracts with elements.
    ...
    */
    ...
    var IntractionPlugin = createPlugin({
        componentIntractions: [DateClicking, DateSelecting, EventDragging, EventResizing],
        calendarIntractions: [UnselectAuto],
    ...
    function splitIntractionByRow(ui, rowCnt) {
        var byRow = [];
        if (!ui) {
            for (var i = 0; i < rowCnt; i += 1) {
                byRow[i] = null;
    ...
    */
    ...
    var Table = /** @class */ (function (_super) {
        ...
        function Table() {
            ...
            _this.splitEventDrag = memoize(splitIntractionByRow);
            _this.splitEventResize = memoize(splitIntractionByRow);
        ...
        Table.prototype.render = function () {
            ...
            return (createElement("div", { className: classNames.join(' '), ref: this.handleRootEl, style: {
                    // these props are important to give this wrapper correct dimensions for Intractions
    ...
    var DayTable = /** @class */ (function (_super) {
        ...
        function DayTable() {
            ...
            _this.handleRootEl = function (rootEl) {
                if (rootEl) {
                    _this.context.registerIntractiveComponent(_this, { el: rootEl });
                }
                else {
                    _this.context.unregisterIntractiveComponent(_this);
                }
            };
            return _this;
        }
    ...
    */
    ...
    function splitIntractionByCol(ui, colCnt) {
        var byRow = [];
        if (!ui) {
            for (var i = 0; i < colCnt; i += 1) {
                byRow[i] = null;
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        TimeCol.prototype.render = function () {
            ...
            var mirrorSegs = (props.eventDrag && props.eventDrag.segs) ||
                ...
                [];
            var IntractionAffectedInstances = // TODO: messy way to compute this
             (props.eventDrag && props.eventDrag.affectedInstances) ||
                (props.eventResize && props.eventResize.affectedInstances) ||
                {};
            return (createElement(DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) { return (createElement("td", __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                createElement("div", { className: "fc-timegrid-col-frame" },
                    ...
                    createElement("div", { className: "fc-timegrid-col-events" }, _this.renderFgSegs(props.fgEventSegs, IntractionAffectedInstances)),
    ...
    var TimeColsContent = /** @class */ (function (_super) {
        ...
        function TimeColsContent() {
            ...
            _this.splitEventDrag = memoize(splitIntractionByCol);
            _this.splitEventResize = memoize(splitIntractionByCol);
            _this.rootElRef = createRef();
    ...
    */
    var ListView = /** @class */ (function (_super) {
        ...
        function ListView() {
            ...
            _this.setRootEl = function (rootEl) {
                if (rootEl) {
                    _this.context.registerIntractiveComponent(_this, {
                        el: rootEl,
                    });
                }
                else {
    ...
    globalPlugins.push(IntractionPlugin, dayGridPlugin, timeGridPlugin, listPlugin, plugin, googleCalendarPlugin);
    ...
    exports.IntractionSettingsStore = IntractionSettingsStore;
    exports.IntractionSettingsToStore = IntractionSettingsToStore;
    ...
    exports.isInt = isInt;
    exports.isIntractionValid = isIntractionValid;
